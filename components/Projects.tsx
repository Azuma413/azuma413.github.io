...
// NOTE: `date` and `venue` values below are PROVISIONAL (inferred from titles/context).
// Replace them with the authoritative list when available — nothing else needs to change.

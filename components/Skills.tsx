        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-4 gap-8 text-center">
          {skillsData.map((skill, index) => (
            <AnimatedDiv key={skill.name} delay={index * 100}>
              <div className="bg-slate-800/50 p-6 rounded-lg shadow-lg flex flex-col items-center justify-center space-y-3 transition-transform duration-300 hover:-translate-y-2 hover:shadow-indigo-500/30 h-full">
